...
require_once($CFG->dirroot . '/lib/accesslib.php'); // ✅ load context classes

$PAGE->set_url('/userpix/index.php');
require_login();

/// Remove the following three lines if you want everyone to access it
/** @var \context_system $syscontext */ // helps Intelephense understand the type
